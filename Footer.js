...
All rights reserved.</p>
        ...
        <div className='col'>
            ...
            <br/>
            <a className="text-muted" style={{textDecoration:"none"}} href="">Open source</a>
            <br/>
        ...
        <div className='col'>
            <p>Support</p>
            <a className="text-muted" style={{textDecoration:"none"}} href="">Contact us</a>
            <br />
            ...
            <br />
            <a className="text-muted" style={{textDecoration:"none"}} href="">Videos</a>
            <br />
            <a className="text-muted" style={{textDecoration:"none"}} href="">Market overview</a>
            <br />
            <a className="text-muted" style={{textDecoration:"none"}} href="">How to file a complaint?</a>
            <br />
        ...
        <div className='col'>
              <p>Account</p>
              <a className="text-muted" style={{textDecoration:"none"}} href="">Open an account</a>
              <br/>
